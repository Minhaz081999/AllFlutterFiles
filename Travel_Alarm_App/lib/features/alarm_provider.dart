...
// Switch Toggle Alarm button on and off
  ...
  Future<void> _showNotificationWithDelay(DateTime scheduledTime, int id) async {
    ...
    await _notificationsPlugin.show(
      id,
      'Alarm Ringing!',
      'Time for your travel event for _showNotificationWithDelay!',
      platformDetails,
    );
    notifyListeners();
  }
  ...
  Future<void> _showNotification(int id) async {
    ...
    await _notificationsPlugin.show(
      id,
      'Alarm Ringing is turned off for _showNotification!',
      "",
      platformDetails,
    );
    notifyListeners();
...
//     await androidImplementation?.requestExactAlarmsPermission();
    ...
    await _notificationsPlugin.zonedSchedule(
      id,
      'Alarm Ringing!',
      'Time for your travel event for _scheduleNotification ${scheduledTime} and ${tz.local}!',
